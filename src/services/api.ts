...
export const attendanceAPI = {
  ...
  getSummary: (
    ...
    return apiRequest(
      `/attendance/summary/${employeeId}?${queryParams.toString()}`
    );
  },
};
...
export const leaveRequestsAPI = {
  ...
  getStats: (params?: {employeeId?: string; month?: string; year?: string}) => {
    ...
    return apiRequest(
      `/leave-requests/stats/summary?${queryParams.toString()}`
    );
  },
};
...
export const notificationsAPI = {
  getByEmployee: (
    ...
    return apiRequest(
      `/notifications/employee/${employeeId}?${queryParams.toString()}`
    );
  },
...
export const settingsAPI = {
  getWorkSettings: () => apiRequest("/settings/work"),
  ...
  getLocationSettings: () => apiRequest("/settings/location"),
};
...
export const rfidDevicesAPI = {
  ...
  getById: (id: string) => apiRequest(`/rfid-devices/${id}`),
  ...
  getUnregisteredCards: () => apiRequest("/rfid-devices/unregistered-cards"),
...
export const divisionsAPI = {
  ...
  getById: (id: string) => apiRequest(`/divisions/${id}`),

  create: (divisionData: {name: string; description?: string}) =>
...
export const salaryAPI = {
  ...
  getById: (id: string) => apiRequest(`/salary/${id}`),
  ...
  getBreakdown: (id: string) => apiRequest(`/salary/${id}/breakdown`),
  getPeriods: () => apiRequest("/salary/periods"),

  getReport: (id: string) => apiRequest(`/salary/${id}/report`),
  ...
  getByEmployee: (
    ...
    return apiRequest(
      `/salary/employee/${employeeId}?${queryParams.toString()}`
    );
  },
};
...
export const salarySettingsAPI = {
  get: () => apiRequest("/salary-settings"),
...
export const workShiftsAPI = {
  getAll: () => apiRequest("/work-shifts"),

  getById: (id: string) => apiRequest(`/work-shifts/${id}`),
