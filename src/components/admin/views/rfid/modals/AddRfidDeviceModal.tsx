...
interface AddRfidDeviceModalProps {
  formData: {
    name: string;
    macAddress: string;
    location: string;
...
const AddRfidDeviceModal: React.FC<AddRfidDeviceModalProps> = ({
  formData,
  onFormDataChange,
  onSubmit,
  onClose
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-4 sm:p-6 w-full max-w-md mx-4">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg sm:text-xl font-bold text-gray-800">Tambah Alat RFID</h3>
          <button
            onClick={onClose}
...
export default AddRfidDeviceModal;